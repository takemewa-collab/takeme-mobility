...
export const API = {
  ...
  DRIVER_OFFER: '/api/driver/offer',
  DRIVER_EARNINGS: '/api/driver/earnings',
  DRIVER_TRIPS: '/api/driver/trips',
  DRIVER_PERFORMANCE: '/api/driver/performance',
  DRIVER_NOTIFICATIONS: '/api/driver/notifications',
  DRIVER_PROFILE: '/api/driver/profile',
  DRIVER_INCENTIVES: '/api/driver/incentives',
  DRIVER_PAYOUTS: '/api/driver/payouts',
  DRIVER_PAYOUTS_ACCOUNT_LINK: '/api/driver/payouts/account-link',
